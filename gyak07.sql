...
/*
3. Készítsen skalár értékű függvényt UDFFerohely néven, amely visszaadja, hogy
a paraméterként megkapott foglalás azonosítóhoz hány férőhelyes szoba tartozik!
...
RETURNS int -- avisszaadott érték típusa 
AS 
BEGIN
    DECLARE @f int -- a férőhelyek száma
